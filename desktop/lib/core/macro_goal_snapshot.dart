...
///
/// Pure over the database, so both the delete-time snapshot and the display path
/// derive the same number, and it is unit-testable against a plain in-memory db.
...
/// `ON DELETE SET NULL` FK would un-link it anyway; this preserves the number.
///
