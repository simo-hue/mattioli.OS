...
/// Critically this refreshes the profile and goal categories too — not just the
/// dashboard + analytics — so a cross-device edit to the user's name/DOB/avatar
/// (shell header) or a goal category shows up without a manual sync or restart,
/// matching mobile's `invalidatePrivateDataProviders`.
