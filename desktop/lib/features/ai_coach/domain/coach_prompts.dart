...
/// and ask for the shape of answer the user benefits from.
class CoachPrompt {
...
///
/// Built in the presentation layer from the live dashboard snapshot and the
/// user's share toggles, so the selection itself stays a pure, unit-testable
/// function of its inputs (mirrors the old `buildAiSuggestions` contract).
