...
class _Translations$icloudSync$es extends Translations$icloudSync$en {
	...
	@override String get syncNowNeedsSync => 'Activa primero la sincronización de iCloud.';
	@override String get title => 'Sincronización de iCloud';
	@override String get unavailablePlatform => 'No disponible en este dispositivo';
}
...
class _Translations$habitsPage$es extends Translations$habitsPage$en {
	...
	@override String dayDotTooltipToday({required Object status}) => 'Hoy · ${status}';
	...
	@override String get useEditHint => 'Usa Editar para cambiar este día.';
	@override String get changesSaved => 'Cambios guardados';
	@override String get discardChangesTitle => '¿Descartar los cambios?';
	@override String get discardChangesBody => 'Los cambios de este día no se han guardado.';
...
class _Translations$goalsPage$es extends Translations$goalsPage$en {
	...
	@override String rangeSameMonth({required Object startDay, required Object endDay, required Object month, required Object year}) => '${startDay} – ${endDay} de ${month} de ${year}';
	@override String rangeSameYear({required Object startDay, required Object startMonth, required Object endDay, required Object endMonth, required Object year}) => '${startDay} de ${startMonth} – ${endDay} de ${endMonth} de ${year}';
	@override String rangeCrossYear({required Object startDay, required Object startMonth, required Object startYear, required Object endDay, required Object endMonth, required Object endYear}) => '${startDay} de ${startMonth} de ${startYear} – ${endDay} de ${endMonth} de ${endYear}';
}
...
class _Translations$settingsPage$es extends Translations$settingsPage$en {
	...
	// Translations
	@override String get aboutCopied => 'Detalles de la versión copiados';
	@override String get aboutCopyTooltip => 'Copiar los detalles de la versión';
	@override String aboutVersion({required Object version, required Object build}) => 'Versión ${version} (${build})';
	...
	@override String get accountPaneSubtitle => 'Con qué cuenta has iniciado sesión y dónde se guardan tus datos.';
	@override String get accountSyncOn => 'Activada — a través de tu cuenta';
	@override String get activateEvolveProStart => 'Suscríbete con tu cuenta de Apple.';
	@override String get advancedPaneSubtitle => 'Ajustes avanzados y diagnóstico.';
	...
	@override String get dataBackupPaneSubtitle => 'Dónde se copian tus datos, cómo importarlos y exportarlos, y cómo borrarlos.';
	@override String get dataRepository => 'Repositorio de datos';
	@override String get dataStorage => 'Almacenamiento de datos';
	@override String get dataStorageAccount => 'Tu cuenta de Evolve';
	@override String get dataStorageThisMac => 'Solo en este Mac, cifrados';
	...
	@override String get disabledTurnOnFirst => 'Activa el recordatorio para elegir una hora.';
	...
	@override String get focusModeOnBody => 'Estos recordatorios están en pausa hasta que la desactives.';
	@override String get focusModeOnTitle => 'Concentración activada';
	...
	@override String get generalPaneSubtitle => 'Cómo se ve y se lee Evolve.';
	...
	@override String get groupAppLock => 'Bloqueo de la app';
	@override String get groupAppearance => 'Apariencia';
	@override String get groupBackups => 'Copias de seguridad';
	@override String get groupDailyReminders => 'Recordatorios diarios';
	@override String get groupDataStorage => 'Almacenamiento de datos';
	@override String get groupDelivery => 'Entrega';
	@override String get groupDiagnostics => 'Diagnóstico';
	@override String get groupDiagnosticsConsent => 'Diagnóstico y consentimientos';
	@override String get groupFocus => 'Concentración';
	@override String get groupGettingStarted => 'Primeros pasos';
	@override String get groupLanguageFormats => 'Idioma y formatos';
	@override String get groupLegal => 'Legal';
	@override String get groupSignIn => 'Inicio de sesión';
	...
	@override String get notificationsPaneSubtitle => 'Todo lo que puede interrumpirte.';
	...
	@override String get perHabitRemindersNote => 'Los recordatorios de cada hábito se configuran en el propio hábito y no dependen de estos interruptores.';
	...
	@override String get privacyPaneSubtitle => 'Qué puede ver Evolve y quién más puede abrirlo.';
	...
	@override String get railGroupData => 'Datos';
	@override String get railGroupYou => 'Tú';
	...
	@override String get restoreDefaults => 'Restaurar los ajustes predeterminados…';
	@override String get restoreDefaultsDetail => 'Tus hábitos, objetivos, cuenta y bloqueo de la app no se modifican.';
	...
	@override String get searchClear => 'Borrar la búsqueda';
	@override String get searchNoResults => 'Ningún ajuste coincide';
	@override String get searchPlaceholder => 'Buscar en los ajustes';
	@override String get sectionAccount => 'Cuenta';
	@override String get sectionAdvanced => 'Avanzado';
	@override String get sectionApplication => 'Aplicación';
	@override String get sectionDataBackup => 'Datos y copias';
	@override String get sectionGeneral => 'General';
	@override String get sectionPrivacy => 'Privacidad';
	@override String get sectionPrivacySecurity => 'Privacidad y seguridad';
	...
	@override String subscribeCta({required Object plan, required Object price}) => 'Suscríbete — ${plan} · ${price}';
	@override String subscribeCtaNoPrice({required Object plan}) => 'Suscríbete — ${plan}';
	@override String get subscription => 'Suscripción';
	@override String get supabaseWithEncryptedCache => 'Supabase con caché cifrada';
	@override String get syncsToIPhoneNote => 'Estos ajustes también se aplican en tu iPhone.';
...
class _Translations$coachSettings$es extends Translations$coachSettings$en {
	...
	@override String get groupEngine => 'Motor';
	@override String get groupPrivacy => 'Privacidad';
	@override String get groupTuning => 'Ajuste del AI Coach';
	...
	@override String get tuningFootnote => 'Se aplican a todos los motores, incluido Evolve AI.';
...
class _Translations$palette$es extends Translations$palette$en {
	...
	// Translations
	@override String get searchHint => 'Busca objetivos, hábitos, ajustes, acciones…';
	...
	@override String get groupSettings => 'Ajustes';
...
class _Translations$targets$es extends Translations$targets$en {
	...
	@override String get amountLabel => 'Alcanza';
	@override String get amountLabelAtMost => 'No superes';
	@override String get stepLabel => 'Paso';
	@override String stepHint({required Object step}) => 'Cada + añade ${step}';
	@override String rangeError({required Object min, required Object max}) => 'Introduce un número entre ${min} y ${max}';
	@override String get stepPositiveError => 'El paso debe ser mayor que 0';
	@override String get stepExceedsWarning => 'Un solo toque superaría todo el objetivo';
	@override String notDivisibleWarning({required Object amount, required Object below, required Object above}) => 'No puedes llegar exactamente a ${amount} — los toques alcanzan ${below} y luego ${above}';
	@override String notDivisibleWarningNoBelow({required Object amount, required Object above}) => 'No puedes llegar exactamente a ${amount} — el primer toque alcanza ${above}';
	@override String tooManyTapsWarning({required Object taps}) => 'Son ${taps} toques para completar un día';
	@override String get confirmTitle => 'Revisa tu objetivo';
	@override String get confirmAdjust => 'Ajustar';
	@override String get confirmSaveAnyway => 'Guardar igualmente';
}
...
class _Translations$ai$consent$es extends Translations$ai$consent$en {
	...
	@override String get consentStatusRevoked => 'No permitido';
	@override String get consentStopSharing => 'Dejar de compartir…';
...
extension on TranslationsEs {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'icloudSync.syncNowNeedsSync' => 'Activa primero la sincronización de iCloud.',
			'icloudSync.title' => 'Sincronización de iCloud',
			'icloudSync.unavailablePlatform' => 'No disponible en este dispositivo',
			...
			'habitsPage.dayDotTooltipToday' => ({required Object status}) => 'Hoy · ${status}',
			...
			'habitsPage.useEditHint' => 'Usa Editar para cambiar este día.',
			'habitsPage.changesSaved' => 'Cambios guardados',
			'habitsPage.discardChangesTitle' => '¿Descartar los cambios?',
			'habitsPage.discardChangesBody' => 'Los cambios de este día no se han guardado.',
			'habitsPage.discard' => 'Descartar',
			'habitsPage.keepEditing' => 'Seguir editando',
			'habitsPage.titleRequired' => 'El título es obligatorio',
			'lavoro' => 'Trabajo',
			'salute' => 'Salud',
			'finanza' => 'Finanzas',
			...
			'goalsPage.rangeSameMonth' => ({required Object startDay, required Object endDay, required Object month, required Object year}) => '${startDay} – ${endDay} de ${month} de ${year}',
			'goalsPage.rangeSameYear' => ({required Object startDay, required Object startMonth, required Object endDay, required Object endMonth, required Object year}) => '${startDay} de ${startMonth} – ${endDay} de ${endMonth} de ${year}',
			'goalsPage.rangeCrossYear' => ({required Object startDay, required Object startMonth, required Object startYear, required Object endDay, required Object endMonth, required Object endYear}) => '${startDay} de ${startMonth} de ${startYear} – ${endDay} de ${endMonth} de ${endYear}',
			...
			'ai.consent.consentStatusRevoked' => 'No permitido',
			'ai.consent.consentStopSharing' => 'Dejar de compartir…',
			...
			'settingsPage.aboutCopied' => 'Detalles de la versión copiados',
			'settingsPage.aboutCopyTooltip' => 'Copiar los detalles de la versión',
			'settingsPage.aboutVersion' => ({required Object version, required Object build}) => 'Versión ${version} (${build})',
			...
			'settingsPage.accountPaneSubtitle' => 'Con qué cuenta has iniciado sesión y dónde se guardan tus datos.',
			'settingsPage.accountSyncOn' => 'Activada — a través de tu cuenta',
			'settingsPage.activateEvolveProStart' => 'Suscríbete con tu cuenta de Apple.',
			'settingsPage.advancedPaneSubtitle' => 'Ajustes avanzados y diagnóstico.',
			...
			'settingsPage.dataBackupPaneSubtitle' => 'Dónde se copian tus datos, cómo importarlos y exportarlos, y cómo borrarlos.',
			'settingsPage.dataRepository' => 'Repositorio de datos',
			'settingsPage.dataStorage' => 'Almacenamiento de datos',
			'settingsPage.dataStorageAccount' => 'Tu cuenta de Evolve',
			'settingsPage.dataStorageThisMac' => 'Solo en este Mac, cifrados',
			...
			'settingsPage.disabledTurnOnFirst' => 'Activa el recordatorio para elegir una hora.',
			...
			'settingsPage.focusModeOnBody' => 'Estos recordatorios están en pausa hasta que la desactives.',
			'settingsPage.focusModeOnTitle' => 'Concentración activada',
			...
			'settingsPage.generalPaneSubtitle' => 'Cómo se ve y se lee Evolve.',
			...
			'settingsPage.groupAppLock' => 'Bloqueo de la app',
			'settingsPage.groupAppearance' => 'Apariencia',
			'settingsPage.groupBackups' => 'Copias de seguridad',
			'settingsPage.groupDailyReminders' => 'Recordatorios diarios',
			'settingsPage.groupDataStorage' => 'Almacenamiento de datos',
			'settingsPage.groupDelivery' => 'Entrega',
			'settingsPage.groupDiagnostics' => 'Diagnóstico',
			'settingsPage.groupDiagnosticsConsent' => 'Diagnóstico y consentimientos',
			'settingsPage.groupFocus' => 'Concentración',
			'settingsPage.groupGettingStarted' => 'Primeros pasos',
			'settingsPage.groupLanguageFormats' => 'Idioma y formatos',
			'settingsPage.groupLegal' => 'Legal',
			'settingsPage.groupSignIn' => 'Inicio de sesión',
			...
			'settingsPage.notificationsPaneSubtitle' => 'Todo lo que puede interrumpirte.',
			...
			'settingsPage.perHabitRemindersNote' => 'Los recordatorios de cada hábito se configuran en el propio hábito y no dependen de estos interruptores.',
			...
			'settingsPage.privacyPaneSubtitle' => 'Qué puede ver Evolve y quién más puede abrirlo.',
			...
			'settingsPage.railGroupData' => 'Datos',
			'settingsPage.railGroupYou' => 'Tú',
			...
			'settingsPage.restoreDefaults' => 'Restaurar los ajustes predeterminados…',
			'settingsPage.restoreDefaultsDetail' => 'Tus hábitos, objetivos, cuenta y bloqueo de la app no se modifican.',
			...
			'settingsPage.searchClear' => 'Borrar la búsqueda',
			'settingsPage.searchNoResults' => 'Ningún ajuste coincide',
			'settingsPage.searchPlaceholder' => 'Buscar en los ajustes',
			'settingsPage.sectionAccount' => 'Cuenta',
			'settingsPage.sectionAdvanced' => 'Avanzado',
			'settingsPage.sectionApplication' => 'Aplicación',
			'settingsPage.sectionDataBackup' => 'Datos y copias',
			'settingsPage.sectionGeneral' => 'General',
			'settingsPage.sectionPrivacy' => 'Privacidad',
			'settingsPage.sectionPrivacySecurity' => 'Privacidad y seguridad',
			...
			'settingsPage.subscribeCta' => ({required Object plan, required Object price}) => 'Suscríbete — ${plan} · ${price}',
			'settingsPage.subscribeCtaNoPrice' => ({required Object plan}) => 'Suscríbete — ${plan}',
			'settingsPage.subscription' => 'Suscripción',
			'settingsPage.supabaseWithEncryptedCache' => 'Supabase con caché cifrada',
			'settingsPage.syncsToIPhoneNote' => 'Estos ajustes también se aplican en tu iPhone.',
			...
			'coachSettings.groupEngine' => 'Motor',
			'coachSettings.groupPrivacy' => 'Privacidad',
			'coachSettings.groupTuning' => 'Ajuste del AI Coach',
			...
			'coachSettings.tuningFootnote' => 'Se aplican a todos los motores, incluido Evolve AI.',
			...
			'palette.searchHint' => 'Busca objetivos, hábitos, ajustes, acciones…',
			...
			'targets.amountLabel' => 'Alcanza',
			'targets.amountLabelAtMost' => 'No superes',
			'targets.stepLabel' => 'Paso',
			'targets.stepHint' => ({required Object step}) => 'Cada + añade ${step}',
			'targets.rangeError' => ({required Object min, required Object max}) => 'Introduce un número entre ${min} y ${max}',
			'targets.stepPositiveError' => 'El paso debe ser mayor que 0',
			'targets.stepExceedsWarning' => 'Un solo toque superaría todo el objetivo',
			'targets.notDivisibleWarning' => ({required Object amount, required Object below, required Object above}) => 'No puedes llegar exactamente a ${amount} — los toques alcanzan ${below} y luego ${above}',
			'targets.notDivisibleWarningNoBelow' => ({required Object amount, required Object above}) => 'No puedes llegar exactamente a ${amount} — el primer toque alcanza ${above}',
			'targets.tooManyTapsWarning' => ({required Object taps}) => 'Son ${taps} toques para completar un día',
			'targets.confirmTitle' => 'Revisa tu objetivo',
			'targets.confirmAdjust' => 'Ajustar',
			'targets.confirmSaveAnyway' => 'Guardar igualmente',
