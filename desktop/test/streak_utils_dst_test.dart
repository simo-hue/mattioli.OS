...
/// express that walk: a 23-hour (spring-forward) day is skipped by a 24h step
/// and a 25-hour (fall-back) day is visited twice.
///
/// These tests run the same assertions over a set of anchor days. In a DST-free
/// zone (CI runs at TZ=UTC) only the plain anchor is exercised; under a
/// DST-observing zone such as the maintainer's own Europe/Rome, the transition
/// anchors are added and the pre-fix Duration walk fails them.
///
