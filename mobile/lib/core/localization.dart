...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    ...
    'English': {
      ...
      'Se devi semplicemente rinominare l\'obiettivo, usa la matita.': 'If you just need to rename the goal, use the pencil.',
      'Infine, questo pulsante elimina definitivamente l\'obiettivo.': 'Finally, this button permanently deletes the goal.',
      'Passa a questa scheda per visualizzare grafici e performance dettagliate selezionando l\'anno corrente o tutti gli anni.': 'Switch to this tab to view charts and detailed performance.',
