...
/// everywhere else in the app) and the three sentence shapes come from
/// `t.macroGoals.range*`, so a translator — Arabic especially — controls word
/// order, punctuation and the dash. That also keeps this function pure and
/// testable with no slang setup. The desktop client carries a byte-identical
/// twin at `lib/core/macro_goal_range_label.dart`; keep the two in step, as is
/// already the convention for `macro_goal_calendar.dart`.
///
...
/// Signatures of the three slang-generated `t.macroGoals.range*` templates.
