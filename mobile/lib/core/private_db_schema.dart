...
///
/// Extracted from [PrivateLocalDatabase] so the DDL and migration logic can run
/// against both the production SQLCipher database AND an in-memory
/// `sqflite_common_ffi` database in tests (the encryption layer is orthogonal to
/// schema correctness). Everything here operates on a [DatabaseExecutor], so it
