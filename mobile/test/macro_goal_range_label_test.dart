...
import 'package:mattioli_os/core/macro_goal_range_label.dart';
...
void main() {
  ...
  String label({
    ...
    return macroGoalRangeLabel(
      ...
      sameMonth: tr.macroGoals.rangeSameMonth,
      sameYear: tr.macroGoals.rangeSameYear,
      crossYear: tr.macroGoals.rangeCrossYear,
    );
  }
