                ...
                <Card className="md:col-span-2 bg-card/40 border-white/5 backdrop-blur-sm overflow-hidden">
                    ...
                    <CardContent>
                        <div className="flex flex-col items-center gap-6">
                            ...
                            {/* Legend - Below Chart - Full Width Grid */}
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2">
                                    {pieData.map((item, index) => {
                                        ...
                                        return (
                                            <div
                                                key={`legend-${index}`}
                                                className="flex items-center justify-between px-3 py-2 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 transition-colors"
                                            >
                                                ...
                                                <span className="text-xs text-muted-foreground font-mono shrink-0 ml-2">{percentage}%</span>
                                            </div>
                                        );
                                    })}
                                </div>
